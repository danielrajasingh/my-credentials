#!/usr/bin/env python3
"""
Regenerator without emoji - ASCII only for Windows compatibility
"""
import os
...
def create_file_content(problem_name, difficulty):
    """Create complete file content - NO EMOJI"""
...
print("Done! Regenerated " + str(total) + " files with comprehensive ASCII comments.")
